...
$(TEST_XDP): tests/test_xdp_filter.o tests/generate_packet.o lib/unity.o | $(BPF_OBJ)
	@echo "  LINK    $@"
	$(CC) $(CFLAGS) tests/test_xdp_filter.o tests/generate_packet.o lib/unity.o -lbpf -lelf -lz -o $@
